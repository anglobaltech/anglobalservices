...
//   const prevSlide = () => {
//     setEnableTransition(true);
//     setCurrentIndex((prev) => (prev === 0 ? totalSlides - 2 : prev - 1));
//   };
...
//             <div
//               ref={clientsRef}
//               className="flex gap-8 w-max py-6 will-change-transform"
...
//       <section className="relative w-full py-14 md:py-20 px-4 md:px-6 bg-gradient-to-br from-slate-50 via-white to-blue-50 overflow-hidden">
//         {/* Decorative accents */}
...
//               WHAT OUR CLIENT SAY
//             </h2>
//             <p className="mt-4 text-slate-600 max-w-2xl mx-auto text-base md:text-md">
//               Trusted by international companies for compliance, certification &
//               consulting
//             </p>
//             <div className="mt-6 flex justify-center">
//               <span className="w-24 h-1 bg-gradient-to-r from-[#2f4f8f] to-cyan-500 rounded-full" />
//             </div>
//           </div>
...
//             <button
//               onClick={prevSlide}
//               className="absolute left-2 lg:left-0 top-1/2 -translate-y-1/2 lg:-translate-x-6 
//         z-20 w-10 h-10 lg:w-12 lg:h-12 rounded-full bg-white/90 backdrop-blur 
//         shadow-lg hover:bg-[#2f4f8f] hover:text-white transition-all"
//             >
...
//             <button
//               onClick={nextSlide}
//               className="absolute right-2 lg:right-0 top-1/2 -translate-y-1/2 lg:translate-x-6 
//         z-20 w-10 h-10 lg:w-12 lg:h-12 rounded-full bg-white/90 backdrop-blur 
//         shadow-lg hover:bg-[#2f4f8f] hover:text-white transition-all"
//             >
...
//                 }}
//               >
//                 {[...testimonials, testimonials[0]].map((t, index) => (
//                   <div
//                     key={index}
//                     className="w-full lg:w-1/2 px-4 lg:px-6 shrink-0"
//                   >
//                     <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl p-6 md:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.08)] border border-slate-100 h-full">
//                       {/* Quote icon */}
//                       {/* <Quote className="absolute top-6 right-6 w-10 h-10 text-[#2f4f8f]/15" /> */}
...
//                         <div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white font-bold text-lg">
//                           {t.name.charAt(0)}
//                         </div>
...
//         {/* <div className="h-1.5 w-full bg-gradient-to-r from-[#0077A8] via-[#0099CC] to-[#0077A8]" /> */}
//       </section>
//     </>
//   );
// }
    ...
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
            ...
            <div>
              ...
              <p className="text-gray-900 mb-4 leading-relaxed">
                ...
                is a well-established and leading consulting firm, the assured service provider. We have placed ourselves amongst a reliable names in the corporate world.
              </p>
              <p className="text-gray-900 mb-4 leading-relaxed">
                We provide Product Certification (ISI mark), Foreign Manufactures Certification Scheme (FMCS), Compulsory Registration Scheme (CRS) for Electronics & IT Goods, BIS Registration hallmarking of precious For metals/jewellery, BEE Certification Services, Trademark Registration Services, CE Services, EPR Authorization (for e-waste), Solar Panel BIS Registration Services, WPC Approval and TEC Certification, MSME Accreditation & NSIC Certification, WMI Certification, NABL Consultancy, WPC License and many more.
              </p>
              <p className="text-gray-900 leading-relaxed">
                Government regulations ensure safety, quality and compliance, helping organizations grow and compete globally.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="w-full bg-[#2f4f8f]">
        <div className="max-w-7xl mx-auto px-6 py-24 text-center text-white">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto opacity-90">
            Get ISI, BIS & Gold Hallmark Certifications with Confidence and Compliance
          </p>
        </div>
      </section>
                  ...
                  {searchResults.length > 0 ? (
                    <ul className="py-2">
                      {searchResults.map((product, index) => (
                        ...
                        >
                          <span className="block text-base font-semibold text-gray-800 line-clamp-1">{product.name}</span>
                          <span className="block text-sm text-[#005f86] mt-1 font-medium">{product.isNo}</span>
                        </li>
                      ))}
                    </ul>
                  ) : (
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16 text-white">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-200 leading-relaxed max-w-lg">
                Want expert guidance on certifications, approvals, or compliance requirements? Speak directly with our experienced technical consultants. Share your details and our team will connect with you shortly to discuss the right solution for your business.
              </p>
            </div>
      ...
      <section className="relative w-full py-14 md:py-20 px-4 md:px-6 bg-gradient-to-br from-slate-50 via-white to-blue-50 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="text-center mb-14 md:mb-16">
            ...
            <p className="mt-4 text-slate-600 max-w-2xl mx-auto text-base md:text-md">
              Trusted by international companies for compliance, certification & consulting
            </p>
            <div className="mt-6 flex justify-center">
              <span className="w-24 h-1 bg-gradient-to-r from-[#2f4f8f] to-cyan-500 rounded-full" />
            </div>
          ...
          <div className="relative">
            ...
            <button
              onClick={prevSlide}
              className="absolute left-2 lg:left-0 top-1/2 -translate-y-1/2 lg:-translate-x-6 z-20 w-10 h-10 lg:w-12 lg:h-12 rounded-full bg-white/90 backdrop-blur shadow-lg hover:bg-[#2f4f8f] hover:text-white transition-all"
            >
              <ChevronLeft className="w-6 h-6 mx-auto" />
            </button>
            <button
              onClick={nextSlide}
              className="absolute right-2 lg:right-0 top-1/2 -translate-y-1/2 lg:translate-x-6 z-20 w-10 h-10 lg:w-12 lg:h-12 rounded-full bg-white/90 backdrop-blur shadow-lg hover:bg-[#2f4f8f] hover:text-white transition-all"
            >
              <ChevronRight className="w-6 h-6 mx-auto" />
            </button>
