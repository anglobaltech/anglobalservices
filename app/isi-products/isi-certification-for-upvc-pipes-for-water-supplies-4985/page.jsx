...
export const metadata = {
  title:
    "ISI Mark Certification for UPVC Pipes for Water Supplies IS 4985 | AN Global Services",

  description:
    "Get ISI Mark Certification for UPVC Pipes for Water Supplies as per IS 4985:2021. Expert BIS support for documentation, product testing, factory inspection, and ISI license approval for Indian and foreign manufacturers.",

  keywords: [
    "ISI Mark Certification for UPVC Pipes",
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-[480px_1fr] gap-12 items-start">
          <div className="relative rounded-xl overflow-hidden shadow-lg bg-white border border-gray-200">
            <Image
              src="/isi-products/isi-certification-upvc-pipes.png"
