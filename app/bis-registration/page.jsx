        ...
        <div className="bg-[#003B7E] text-white text-[11px] md:text-sm">
          <div className="max-w-7xl mx-auto px-4 py-2 flex flex-col items-center md:flex-row md:items-center md:justify-between gap-1">
            ...
            <p className="hidden md:block">
              India’s Leading BIS Certification Consultant for All Products &
              Industries
            </p>
        ...
        <section className="py-14 px-4 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-extrabold text-[#003B7E] text-center mb-3">
              BIS Certification &amp; Licensing Made Simple
            </h2>
            <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
              AN Global Services simplifies BIS Certification, ISI Mark
              Licensing, CRS Registration, FMCS across India and globally.
            </p>
              ...
              {[
                {
                  ...
                  desc: "End-to-end support for obtaining ISI Mark License - from documentation to factory inspection and BIS approval.",
                },
                {
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                {
                  name: "Rajesh Kumar",
                  role: "Director, TechVision Electronics",
                  text: "AN Global Services made our CRS registration completely hassle-free. They handled everything from lab testing to BIS portal submission. Got our certificate in record time!",
                },
                {
                  name: "Michael Chen",
                  role: "Head of Compliance, SinoTech Exports",
                  text: "As a foreign manufacturer, FMCS registration seemed daunting. The team guided us through every step. Highly professional and knowledgeable about BIS regulations.",
                },
                {
                  name: "Priya Sharma",
                  role: "Owner, Lumex India Pvt Ltd",
                  text: "Got our ISI mark license for LED products within 4 months. The team was transparent about every step, costs, and timelines. Strongly recommended!",
                },
              ].map((t) => (
                <div
                  key={t.name}
