...
export default function BabyDiapersPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Our baby diapers feature a dermatologically tested, hypoallergenic top sheet and a breathable cloth-like backsheet. This ensures maximum airflow, preventing moisture entrapment and diaper rash for sensitive baby skin."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, our diapers utilize a high-capacity Super Absorbent Polymer (SAP) and fluff pulp core with 3D leak guards. They instantly lock in fluids to provide up to 12 hours of overnight leak-proof protection, keeping babies completely dry."
    },
    {
  ...
  const specs = [
    ...
    { label: "Sizes Available", value: "Small (S), Medium (M), Large (L), Extra Large (XL)" },
  ];
  ...
  const qualityStandards = [
    ...
    { label: "Leak Protection", value: "3D Leak-guard Technology" },
  ];
              ...
              <div className="w-full lg:w-2/3 space-y-16">
                  ...
                  <div className="mb-10 mt-12">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 items-stretch">
                      ...
                      <div className="flex items-start gap-4 bg-white rounded-xl px-5 py-4 border border-gray-100 shadow-sm hover:shadow-md hover:border-blue-600/20 transition-all h-full">
                        <CheckCircle2 className="text-green-500 shrink-0 mt-1" size={24} />
                        <div>
                          <h4 className="font-bold text-gray-800 mb-1">Comfort Fit</h4>
                          <span className="text-gray-600 leading-relaxed text-sm">Elastic waistband and 3D leak guards for ultimate comfort.</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <LazySection>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-stretch">
                    ...
                    <div className="flex flex-col justify-center bg-white border border-gray-100 rounded-2xl p-6 hover:shadow-xl hover:border-blue-600/30 hover:-translate-y-1 transition-all duration-300 group h-full">
                      ...
                      <p className="text-gray-600 text-base leading-relaxed">The high-grade SAP (Super Absorbent Polymer) rapidly locks in moisture and converts it into a gel. This ensures the surface remains completely dry, providing up to 12 hours of overnight comfort.</p>
                    </div>
                    ...
                    <div className="flex flex-col justify-center bg-white border border-gray-100 rounded-2xl p-6 hover:shadow-xl hover:border-blue-600/30 hover:-translate-y-1 transition-all duration-300 group h-full">
                      ...
                      <p className="text-gray-600 text-base leading-relaxed">Smart wetness indicator strips change color when the diaper is full, taking the guesswork out of changing time and ensuring the baby remains dry and happy.</p>
                    </div>
                ...
                <LazySection>
                  <div className="bg-gradient-to-br from-[#0a192f] to-[#112340] rounded-3xl p-8 sm:p-12 text-center text-white shadow-2xl relative overflow-hidden mt-8">
                    ...
                    <div className="relative z-10">
                      <h3 className="text-3xl font-extrabold mb-6">Ready to Stock Premium Baby Diapers?</h3>
