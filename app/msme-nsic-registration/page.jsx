...
export default function MSMENSICRegistrationPage() {
  return (
    <main className="w-full">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 pt-12 grid grid-cols-1 xl:grid-cols-2 gap-10 lg:gap-14 items-start">
