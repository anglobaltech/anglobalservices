...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: "/testing_gold",
        destination: "/gold-testing-services",
        permanent: true, 
      },
      { source: "/testing-toys", destination: "/toys-testing-services", permanent: true },
      { source: "/gold-testing", destination: "/gold-testing-services", permanent: true },
      { source: "/testing_footwear", destination: "/footwear-testing-services", permanent: true },
      { source: "/testing_solar_panel", destination: "/solar-panel-testing-services", permanent: true },
